...
xcrun -sdk iphoneos clang *.m ../bundlehooks/*.m  ../litehook/litehook.c -o generalhook.dylib -arch arm64 -I../litehook/ -I../bundlehooks/ -dynamiclib -miphoneos-version-min=16.0 -framework Foundation -O2 -Wno-deprecated-declarations -framework CoreTelephony

...
xcrun -sdk iphoneos clang *.m ../bundlehooks/utils.m  ../litehook/litehook.c -o generalhook.dylib -arch arm64 -I../litehook/ -I../bundlehooks/ -dynamiclib -miphoneos-version-min=16.0 -fmodules -O3 -Wno-deprecated-declarations -framework CoreTelephony

...
xcrun -sdk iphoneos clang *.m ../bundlehooks/*.m -o appstorehelper.dylib -arch arm64 -dynamiclib -miphoneos-version-min=16.0 -fmodules -O3 -Wno-deprecated-declarations -I../bundlehooks/
